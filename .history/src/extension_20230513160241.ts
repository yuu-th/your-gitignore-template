...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("your-gitignore-template.createGitignore", () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("your-gitignore-template.saveGitignore", () => {
      // your-gitignore-template.saveGitignoreコマンドの処理
